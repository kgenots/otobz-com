    ...
    <footer className="border-t border-[#dedee5] py-8 px-6">
      <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-[#686b82]">
        ...
        <div className="flex gap-4">
          <a href="https://trip.otobz.com" className="hover:text-[#101114] transition-colors">trip</a>
          <a href="https://blog.otobz.com" className="hover:text-[#101114] transition-colors">blog</a>
        </div>
      </div>
    </footer>
  );
