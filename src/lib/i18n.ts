export const translations: Record<string, Record<string, string>> = {
  ...
  "agents.subtitle": {
    ko: "자율형 AI 에이전트가 24/7 운전을 담당합니다 — 인간은 필요 없습니다.",
    en: "Autonomous AI agents handle operations 24/7 — no humans needed.",
    ja: "自律型AIエージェントが24/7運用を担います — 人間は不要。",
    es: "Nuestros agentes de IA autónomos manejan operaciones 24/7 — sin humanos necesarios.",
    de: "Unsere autonomen KI-Agenten übernehmen den Betrieb 24/7 — keine Menschen nötig.",
    it: "I nostri agenti AI autonomi gestiscono le operazioni 24/7 — senza umani necessari.",
    fr: "Nos agents IA autonomes gèrent les opérations 24/7 — sans humains nécessaires.",
  },
  "agent1.name": { ko: "콘텐츠 에이전트", en: "Content Agent", ja: "コンテンツエージェント", es: "Agente de Contenido", de: "Content-Agent", it: "Agente Contenuti", fr: "Agent Contenu" },
  "agent1.desc": {
    ko: "에이전트가 매일 블로그 포스트, 제품 업데이트, 시장 리포트를 자동 발행합니다.",
    en: "AI agents auto-generate blog posts, product updates, and market reports every day.",
    ...
    de: "Generiert automatisch Blog-Posts, Produkt-Updates und Marktberichte jeden Tag.",
  ...
  "agent2.name": { ko: "모니터링 에이전트", en: "Monitoring Agent", ja: "モニタリングエージェント", es: "Agente de Monitoreo", de: "Monitoring-Agent", it: "Agente di Monitoraggio", fr: "Agent de Surveillance" },
  "agent2.desc": {
    ko: "KIS 데이터, 경고, 포트폴리오 성과를 실시간으로 추적합니다.",
  ...
  "agent3.name": { ko: "리서치 에이전트", en: "Research Agent", ja: "リサーチエージェント", es: "Agente de Investigación", de: "Forschungs-Agent", it: "Agente di Ricerca", fr: "Agent de Recherche" },
  "agent3.desc": {
  ...
  "service.coming": { ko: "더 많은 서비스 준비 중.<br />AI 기반 제품으로 고객 가치를 창출합니다.", en: "More services in preparation.<br />Creating customer value with AI-powered products.", ja: "より多くのサービス準備中。<br />AI搭載製品で顧客価値を創造します。", es: "Más servicios en preparación.<br />Creando valor del cliente con productos impulsados por IA.", de: "Mehr Services in Vorbereitung.<br />Erstellen von Kundenwert mit KI-gestützten Produkten.", it: "Altri servizi in preparazione.<br />Creando valore del cliente con prodotti basati sull'AI.", fr: "Plus de services en préparation.<br />Créer de la valeur client avec des produits alimentés par l'IA." },
  // Blog
  "blog.title": { ko: "블로그", en: "Blog", ja: "ブログ", es: "Blog", de: "Blog", it: "Blog", fr: "Blog" },
  "blog.description": { ko: "OTOBZ가 배우고 구축하는 과정들을 기록합니다.", en: "OTOBZ documents what we learn and build.", ja: "OTOBZが学び、構築する過程を記録。", es: "OTOBZ documenta lo que aprendemos y construimos.", de: "OTOBZ dokumentiert, was wir lernen und bauen.", it: "OTOBZ documenta ciò che apprendiamo e costruiamo.", fr: "OTOBZ documente ce que nous apprenons et construisons." },
  "blog.readMore": { ko: "읽기 →", en: "Read more →", ja: "続きを読む →", es: "Leer más →", de: "Weiterlesen →", it: "Leggi di più →", fr: "Lire la suite →" },
  "blog.back": { ko: "← 블로그 목록", en: "← Blog", ja: "← ブログ", es: "← Blog", de: "← Blog", it: "← Blog", fr: "← Blog" },
...
export function getLocale(): string {
  ...
  for (const cookie of cookies) {
    ...
    if (name === "NEXT_LOCALE") return decodeURIComponent(value);
  }
  const navLocale = navigator.language.slice(0, 2);
  if (["ko", "en", "ja", "es", "de", "it", "fr"].includes(navLocale)) return navLocale;
  return "en";
}
